...
public class ResponseBody<T> {
    ...
    public static class BodyBuilder {
        ...
        public <T> ResponseEntity<ResponseBody<T>> body(@Nullable T body) {
            return new ResponseEntity<>(
                    new ResponseBody<>(this.timestamp, this.status, HttpStatus.resolve(this.status).getReasonPhrase(),
                            null, body),
                    this.headers,
                    HttpStatus.resolve(this.status));
        }

        public <T> ResponseEntity<ResponseBody<T>> errors(@Nullable List<ErrorContent> errors) {
            return new ResponseEntity<>(new ResponseBody<>(this.timestamp, this.status, HttpStatus.resolve(this.status)
                    .getReasonPhrase(), errors, null), this.headers,
                    HttpStatus.resolve(this.status));
        }
    }
    ...
    public static <T> ResponseEntity<ResponseBody<T>> badRequest(@Nullable List<ErrorContent> errors) {
    ...
    public static <T> ResponseEntity<ResponseBody<T>> unauthorized(@Nullable List<ErrorContent> errors) {
    ...
    public static <T> ResponseEntity<ResponseBody<T>> forbidden(@Nullable List<ErrorContent> errors) {
    ...
    public static <T> ResponseEntity<ResponseBody<T>> notFound(@Nullable List<ErrorContent> errors) {
    ...
    public static <T> ResponseEntity<ResponseBody<T>> conflict(@Nullable List<ErrorContent> errors) {
    ...
    public static <T> ResponseEntity<ResponseBody<T>> internalServerError(@Nullable List<ErrorContent> errors) {
